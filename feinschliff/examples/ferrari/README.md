...
- Tokens: [`feinschliff/brands/ferrari/tokens.json`](../../brands/ferrari/tokens.json) — derived from [getdesign.md/ferrari/design-md](https://getdesign.md/ferrari/design-md).
- Renderer: [`feinschliff/brands/ferrari/renderers/pptx/`](../../brands/ferrari/renderers/pptx/) — same shape as the Feinschliff renderer; only the brand-scoped chrome (heraldic-shield glyph, FERRARI wordmark, pgmeta defaults) and tokens differ.
