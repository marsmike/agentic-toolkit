"""Feinschliff PowerPoint Template — build entrypoint.

Run:   uv run python build.py
Output: out/Claude-Template.pptx
"""
...
from master import (
    apply_claude_theme, set_slide_size, ensure_n_layouts,
...
OUT_DIR = HERE / "out"
OUT_FILE = OUT_DIR / "Claude-Template.pptx"
...
def main(include_demo_slides: bool = True):
    ...
    # 2. Theme (colour + font scheme) → feinschliff tokens
    apply_claude_theme(prs)
