...
def build(layout):
    ...
    add_text_placeholder(
        ...
        color=T.ACCENT, uppercase=True, tracking_em=0.115,
    )
    ...
    for i, (lc, lt, rc, rt, ct) in enumerate(_SAMPLE_PAIRS):
        ...
        add_text_placeholder(
            ...
            color=T.GRAPHITE, uppercase=True, tracking_em=0.115,
        )
        add_text_placeholder(
        ...
        add_text_placeholder(
            ...
            color=T.ACCENT_HOVER, uppercase=True, tracking_em=0.115,
            align="r",
        )
        add_text_placeholder(
    ...
    add_text_placeholder(
        ...
        color=T.WHITE, tracking_em=0, align="c",
    )
