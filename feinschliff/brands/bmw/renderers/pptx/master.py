...
Public API (in call order from build.py):
  ...
  2. `apply_bmw_theme`       — rewrite clrScheme + fontScheme to BMW tokens.
...
def apply_bmw_theme(prs):
    """Rewrite the theme's clrScheme + fontScheme to BMW tokens."""
