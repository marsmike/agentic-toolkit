...
def build_demo_deck(prs: Presentation):
    ...
    # KPI Grid — BMW spec-cell pattern: 4 KPIs, each with value + unit + key + delta
    add(prs, "Feinschliff · KPI Grid",
        _10="At a glance",
        _0="Performance figures.",
        _20="Peak output",       _21="+19% YoY",
        _22="0 — 100 km/h",      _23="Best in class",
        _24="WLTP range",        _25="8 regions",
        _26="Green electricity", _27="Since 2020",
        _30="462",  _31=" kW",
        _32="3.0",  _33=" s",
        _34="750",  _35=" km",
        _36="100",  _37="%")
