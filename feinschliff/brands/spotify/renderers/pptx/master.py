...
Public API (in call order from build.py):
  ...
  2. `apply_spotify_theme`   — rewrite clrScheme + fontScheme to Spotify tokens.
...
def apply_spotify_theme(prs):
    """Rewrite the theme's clrScheme + fontScheme to Spotify tokens."""
