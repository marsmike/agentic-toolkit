...
Public API (in call order from build.py):
  ...
  2. `apply_feinschliff_theme` — rewrite clrScheme + fontScheme to feinschliff tokens.
...
def apply_feinschliff_theme(prs):
    """Rewrite the theme's clrScheme + fontScheme to feinschliff tokens."""
    ...
    if clr_scheme is not None:
        ...
        clr_scheme.set("name", "Feinschliff")
    ...
    if font_scheme is not None:
        ...
        font_scheme.set("name", "Feinschliff")
