...
Public API (in call order from build.py):
  ...
  2. `apply_ferrari_theme` — rewrite clrScheme + fontScheme to Ferrari tokens.
...
def apply_ferrari_theme(prs):
    """Rewrite the theme's clrScheme + fontScheme to Ferrari tokens."""
