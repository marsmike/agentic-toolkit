...
convention (see [[Test-Corpus-Map]]). 72 entries.
...
- [[04_Resources/Concepts/Surprise-Scoring|Surprise Scoring]] — Scoring a graph edge by how unexpected it is given the rest of the graph's structure, so a genuinely novel…
...
- [[04_Resources/Tools/Farsight|Farsight]] — The hybrid BM25+vector search engine — Rust, CLI-in/JSON-out, queries vault notes and PDF chunks with one engine.
...
- [[04_Resources/Tools/Gaiafield|Gaiafield]] — The knowledge-graph engine — extracts the graph that already exists in wikilinks, frontmatter, and tags into a queryable store, deterministic…
